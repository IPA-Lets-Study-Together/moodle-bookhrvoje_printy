...
require_capability('bookhrvoje/printy:printy', $context);
...
$PAGE->set_url('/mod/book/printy.php', array('id'=>$id, 'chapterid'=>$chapterid));
...
if ($chapter) {
    ...
    <head>
      ...
      <link rel="stylesheet" type="text/css" href="printy.css" />
    </head>
    <body>
    <?php
    // Print dialog link.
    $printtext = get_string('printchapter', 'bookhrvoje_printy');
    $printicon = $OUTPUT->pix_icon('chapter', $printtext, 'bookhrvoje_printy', array('class' => 'book_print_icon'));
    ...
    <?php
    // Print dialog link.
    $printtext = get_string('printbook', 'bookhrvoje_printy');
    $printicon = $OUTPUT->pix_icon('book', $printtext, 'bookhrvoje_printy', array('class' => 'book_print_icon'));
    $printlinkatt = array('onclick' => 'window.print();return false;', 'class' => 'book_no_print');
    echo html_writer::link('#', $printicon.$printtext, $printlinkatt);
    ?>
    <a name="top"></a>
    ...
    <td><?php echo get_string('printedby', 'bookhrvoje_printy') ?>:</td>
    <td><?php echo fullname($USER, true) ?></td>
    </tr><tr>
    <td><?php echo get_string('printdate', 'bookhrvoje_printy') ?>:</td>
    <td><?php echo userdate(time()) ?></td>
    </tr>
    </table></div>

    <?php
    list($toc, $titles) = bookhrvoje_printy_get_toc($chapters, $book, $cm);
    echo $toc;
    // chapters
